...
const InvoiceList = () => {
  ...
  return (
    <div className="p-6 pt-50 w-full pb-24 bg-gray-50 min-h-screen">
      {!selectedInvoice ? (
        <>
          <div className="mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 max-w-4xl mx-auto mt-8 mb-10">
          <button
            onClick={() => {
              ...
              <span
                ...
                ${
                  selectedInvoice.status === "Đã thanh toán"
                    ...
                    : selectedInvoice.status === "Chờ xác nhận"
          ...
          <div className="grid grid-cols-2 gap-12 mb-8">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">
                SĐT: {selectedInvoice.phoneNumber}
              </p>
              <p className="text-gray-600 text-sm">
                Địa chỉ: {selectedInvoice.adress}
              </p>
            </div>
            <div className="text-right">
              <h3 className="text-gray-500 text-xs font-bold uppercase mb-2">
              ...
              <tbody>
                {selectedInvoice.items.map((item, idx) => (
                  <tr key={idx} className="border-b border-gray-100">
                    ...
                    <td className="py-4 text-right pr-4 font-bold text-gray-800">
                      {item.price}
                    </td>
                  </tr>
                ))}
